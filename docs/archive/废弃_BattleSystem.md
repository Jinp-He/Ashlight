...
> ⚠️ **已过时（2026-07-09 标注）**：本文描述的「0–100 段位 ATB + 全场暂停 + 意图轴/执行轴双轴敌人」是重构前的旧系统，**勿作为设计或实现依据**。现行基准：[规则书_角色卡牌设计](../规则书_角色卡牌设计.md)（公共回合离散调度）、[职业设计_三职业与公用系统](../职业设计_三职业与公用系统.md)、[天气系统设计_v1](../天气系统设计_v1.md)。
