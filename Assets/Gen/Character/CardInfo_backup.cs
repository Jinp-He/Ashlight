...
{
public sealed partial class CardInfo_backup : Luban.BeanBase
{
    public CardInfo_backup(JSONNode _buf) 
    {
    ...
    public static CardInfo_backup DeserializeCardInfo_backup(JSONNode _buf)
    {
        return new Character.CardInfo_backup(_buf);
    }
    ...
    public const int __ID__ = -1277759426;
