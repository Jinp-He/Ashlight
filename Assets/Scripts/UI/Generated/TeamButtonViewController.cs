...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class TeamButtonViewController : MonoBehaviour
    {
        #region UI Bindings

        public Button Btn_TrashCanBas;
        public Button Btn_Slot01;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                switch (bindName)
                {
                    case "Btn_TrashCanBas":
                        Btn_TrashCanBas = bind.GetComponent<Button>();
                        break;
                    case "Btn_Slot01":
                        Btn_Slot01 = bind.GetComponent<Button>();
                        break;
