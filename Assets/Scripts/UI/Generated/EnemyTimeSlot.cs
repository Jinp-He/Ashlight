...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class EnemyTimeSlot : MonoBehaviour
    {
        #region UI Bindings

        public DescriptionViewController DescriptionViewController;
        public Image Channeling;
            ...
            foreach (UIBind bind in binds)
            {
                ...
                switch (bindName)
                {
                    case "DescriptionViewController":
                        DescriptionViewController = bind.GetComponent<DescriptionViewController>();
                        break;
                    case "Channeling":
                        Channeling = bind.GetComponent<Image>();
                        break;
                    case "Duration":
                        Duration = bind.GetComponent<Image>();
                        break;
                    case "Icon":
                        Icon = bind.GetComponent<Image>();
                        break;
                    case "Recoil":
                        Recoil = bind.GetComponent<Image>();
                        break;
                }
            }
        }
