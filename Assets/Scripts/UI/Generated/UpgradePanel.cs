...
namespace Scripts.UI
{
    ...
    public partial class UpgradePanel : MonoBehaviour
    {
        ...
        public BaixiangPanel BaixiangPanel;
        public RectTransform ExpArea;
        public RectTransform ChooseCardPanel;
        public RectTransform CardParent;
        public Button Btn_SkipChoose;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "BaixiangPanel":
                        BaixiangPanel = bind.GetComponent<BaixiangPanel>();
                        break;
                    case "ExpArea":
                        ExpArea = bind.GetComponent<RectTransform>();
                        break;
                    case "ChooseCardPanel":
                        ChooseCardPanel = bind.GetComponent<RectTransform>();
                        break;
                    case "CardParent":
                        CardParent = bind.GetComponent<RectTransform>();
                        break;
                    case "Btn_SkipChoose":
                        Btn_SkipChoose = bind.GetComponent<Button>();
                        break;
                }
            }
        }
