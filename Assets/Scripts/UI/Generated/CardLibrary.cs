...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class CardLibrary : MonoBehaviour
    {
        #region UI Bindings

        public TMP_InputField Search;
        public RectTransform CardLibraryContainer;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "Search":
                        Search = bind.GetComponent<TMP_InputField>();
                        break;
                    case "CardLibraryContainer":
                        CardLibraryContainer = bind.GetComponent<RectTransform>();
                        break;
                }
            }
        }
