...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class UI_Buff : MonoBehaviour
    {
        #region UI Bindings

        public Image Img_AttUp;
        public TextMeshProUGUI Txt_Plies;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "Img_AttUp":
                        Img_AttUp = bind.GetComponent<Image>();
                        break;
                    case "Txt_Plies":
                        Txt_Plies = bind.GetComponent<TextMeshProUGUI>();
                        break;
                }
            }
        }
