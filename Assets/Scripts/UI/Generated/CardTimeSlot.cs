...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class CardTimeSlot : MonoBehaviour
    {
        #region UI Bindings

        public Image Channeling;
        public Image Duration;
        public Image MiniSprite;
            ...
            foreach (UIBind bind in binds)
            {
                ...
                switch (bindName)
                {
                    ...
                    case "Duration":
                        ...
                        break;
                    case "MiniSprite":
                        MiniSprite = bind.GetComponent<Image>();
                        break;
                    case "CardNameText":
                        CardNameText = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "Recoil":
