...
namespace Scripts.UI
{
    ...
    public partial class BaixiangPanel : MonoBehaviour
    {
        ...
        public RectTransform Baixiang1;
        public RectTransform Baixiang2;
        public RectTransform Baixiang3;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "Baixiang1":
                        Baixiang1 = bind.GetComponent<RectTransform>();
                        break;
                    case "Baixiang2":
                        Baixiang2 = bind.GetComponent<RectTransform>();
                        break;
                    case "Baixiang3":
                        Baixiang3 = bind.GetComponent<RectTransform>();
                        break;
                    case "HeadImage":
                        HeadImage = bind.GetComponent<Image>();
                        break;
                }
            }
        }
