...
namespace Scripts.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class DescriptionViewController : MonoBehaviour
    {
        #region UI Bindings

        public TextMeshProUGUI Txt_EntryName;
        public TextMeshProUGUI Txt_Entry;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "Txt_EntryName":
                        Txt_EntryName = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "Txt_Entry":
                        Txt_Entry = bind.GetComponent<TextMeshProUGUI>();
                        break;
                }
            }
        }
