...
namespace Scripts.UI
{
    ...
    public partial class Baixiang : MonoBehaviour
    {
        ...
        public Image img_BaixiangBackground;
        public TextMeshProUGUI Txt_BaixiangEffect;
        public TextMeshProUGUI Txt_SupplementaryText;
        public TextMeshProUGUI Txt_BaixiangName;
        public Image img_BaixiangIcon;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                switch (bindName)
                {
                    case "img_BaixiangBackground":
                        img_BaixiangBackground = bind.GetComponent<Image>();
                        break;
                    case "Txt_BaixiangEffect":
                        Txt_BaixiangEffect = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "Txt_SupplementaryText":
                        Txt_SupplementaryText = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "Txt_BaixiangName":
                        Txt_BaixiangName = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "img_BaixiangIcon":
                        img_BaixiangIcon = bind.GetComponent<Image>();
                        break;
                }
            }
        }
