...
namespace Ashlight.UI
{
    ...
    /// 自动生成的UI绑定代码
    /// </summary>
    public partial class CardPrefab : MonoBehaviour
    {
        #region UI Bindings
        ...
        public Image CardPrevColor;
        public Image CardNextColor;
        ...
        private void InitUIBindings()
        {
            ...
            foreach (UIBind bind in binds)
            {
                ...
                {
                    case "CardImage":
                        CardImage = bind.GetComponent<Image>();
                        break;
                    case "CardName":
                        CardName = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "CardCost":
                        CardCost = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "CardDesc":
                        CardDesc = bind.GetComponent<TextMeshProUGUI>();
                        break;
                    case "CardPrevColor":
                        CardPrevColor = bind.GetComponent<Image>();
                        break;
                    case "CardNextColor":
                        CardNextColor = bind.GetComponent<Image>();
                        break;
                }
            }
        }
